			...
			<ol class="property-list race">
				...
				<li class="fieldcontain">
					<span id="city-label" class="property-label"><g:message code="race.city.label" default="City" /></span>
						...
						<span class="property-value" aria-labelledby="city-label">
							<g:fieldValue bean="${raceInstance}" field="city"/></span>
				...
				<li class="fieldcontain">
					<span id="distance-label" class="property-label"><g:message code="race.distance.label" default="Distance" /></span>
						...
						<span class="property-value" aria-labelledby="distance-label">
							<g:formatNumber number="${raceInstance.distance}"  format="##0.0 mi"/>
						</span>
				...
				<li class="fieldcontain">
					<span id="cost-label" class="property-label"><g:message code="race.cost.label" default="Cost" /></span>
						...
						<span class="property-value" aria-labelledby="cost-label">
							<g:formatNumber number="${raceInstance.cost}" format="\$##0.00" /></span>
